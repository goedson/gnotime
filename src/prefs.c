...
prefs_set(GnomePropertyBox * pb, gint page, PrefsDialog *odlg)
{
	...
	if (4 == page)
	{
		...
		/* toolbar */
		config_show_toolbar = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON(odlg->show_toolbar));
		config_show_tb_tips = gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON(odlg->show_tb_tips));
